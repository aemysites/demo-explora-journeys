...
## Environments
- Preview: https://main--demo-explora-journeys--aemysites.aem.page/
- Live: https://main--demo-explora-journeys--aemysites.aem.live/
- Block Library: https://main--demo-explora-journeys--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `demo-explora-journeys` directory in your favorite IDE and start coding :)
